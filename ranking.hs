...
insert name_points level rank | level == 1 then orderedRank $ addInRank name_points rank 
                              | level == 2 then orderedRank $ addInRank name_points rank
                              | level == 3 then orderedRank $ addInRank name_points rank
